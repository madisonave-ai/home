...
const Content = () => {
  return (
    <div>
      ...
      <p>
        We are MadisonAve AI Inc. ("Company," "we," "us," "our"), a company
        registered in Canada at Orangeville, Ontario L9W 1H3. Our
        Corporation number is 1459119- 4. We operate the website
        <Link
          sx={{ml:1, mr:1}}
          component="a"
          href="https://madisonave.ai/"
        ...
        and its various subdomains (the "Site"), as well as any other
        related products and services that refer or link to these legal
        terms (the "Legal Terms") (collectively, the "Services"). You can
        contact us by email at contact@madisonave.ai.
      </p>
      <p>
        These Legal Terms constitute a legally binding agreement made
        between you, whether personally or on behalf of an entity ("you"),
        and MadisonAve AI Inc., concerning your access to and use of the
      ...
      <p>
        ...
        please address your request to: contact@madisonave.ai. If we ever
      ...
      <p>
        ...
        parental permission to use the Services; (4) you will not access the
        Services through automated or non-human means, whether through a
        bot, script or otherwise; (5) you will not use the Services for any
        illegal or unauthorized purpose; and (6) your use of the Services
      ...
      <p>
        ...
        part of the Services. Except as may be the result of standard search
      ...
      <p>
        ...
        Contributions to the Services and you expressly agree to exonerate
      ...
      <p>
        ...
        Policy: https://madisonave.ai/#/privacy. By using the Services, you
        ...
        Canada and United States. If you access the Services from any other
        region of the world with laws or other requirements governing
        personal data collection, use, or disclosure that differ from
        applicable laws in Canada and United States, then through your
        continued use of the Services, you are transferring your data to
        Canada and United States, and you expressly consent to have your
        data transferred to and processed in Canada and United States.
      ...
      <p>
        ...
        laws of Canada. MadisonAve AI Inc. and yourself irrevocably consent
      ...
      <p>
        ...
        arbitrators shall be . The seat, or legal place, or arbitration
        shall be Canada. The language of the proceedings shall be . The
      ...
      <h1>23. BETA</h1>
      <p>
        By using our website during the beta period, you agree to provide
        feedback on your experience using our product. This feedback may
        include, but is not limited to, bug reports, feature requests, and
        general usability feedback. You acknowledge and agree that any
        feedback provided by you is voluntary and that we may use such
        feedback for any purpose without obligation of confidentiality or
        compensation to you. We appreciate your willingness to provide
        feedback and we value your input as we work to improve our product.
        We may reach out to you directly to gather additional feedback or
        information, and we may also use your feedback to inform future
        updates and changes to the product. Please note that your use of our
        product during the beta period is at your own risk and we make no
        representations or warranties of any kind, express or implied,
        regarding the performance or availability of our product during this
        period. We reserve the right to modify, suspend, or terminate access
        to our product at any time, with or without notice. Thank you for
        participating in our beta program and for helping us to build a
        better product.
      </p>
      <h1>23. CONTACT US</h1>
      <p>
      ...
      <p>
        MadisonAve AI Inc. Orangeville, Ontario L9W 1H3 Canada
        <ul>
          <li>
            <p>By email: contact@madisonave.ai</p>
          </li>
          <li>
            <p>
              ...
              <Link
                ...
                color={'text.primary'}
              >
                https://madisonave.ai/#/contact-us
              </Link>
            </p>
          </li>
        </ul>
